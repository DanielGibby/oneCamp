...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["button"]) {
            ...
            echo ";\" class=\"col-lg-3 col-md-4 col-sm-6 homepage-tiles--tile\"><a href=\"";
...
\t\t\t<div style=\"border: 2px solid {{ button.default_color }};\" class=\"col-lg-3 col-md-4 col-sm-6 homepage-tiles--tile\"><a href=\"{{ button.link }}\"><i style=\"font-color: {{ button.default_color }};\" class=\"{{ button.icon }}\"></i><br /><span>{{ button.title }}</span></a></div>
\t\t{% endfor %}
\t</div>
